...
// Данные нового товара с уникальным SKU
$productData = [
    'title' => 'Новый тестовый товар ' . date('Y-m-d H:i:s'),
    'sku' => 'TEST-' . rand(1000, 9999), // Случайный SKU
    'price' => 99.99,
    'stock' => 10,
    'status' => 'published',
    'description' => 'Тестовый товар создан через скрипт API'
];
